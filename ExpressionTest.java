...
public class ExpressionTest extends BaseTest {
    ...
    protected void checkEqualsAndToString(final String full, final String mini, final ToMiniString expression) {
        ...
        for (Object prev : prev) {
            ...
            assertTrue("Inconsistent hashCode: prev:" + prev.hashCode() + prev.toString() + " expression:" + expression.hashCode() + expression.toString(), (prev.hashCode() == expression.hashCode()) == equals);
            counter.passed(); 
        }
